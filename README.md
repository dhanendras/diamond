...
This application is designed to demonstrate how assets can be modeled on the Blockchain using a car leasing scenario. In the scenario assets are modeled using Blockchain technology with the following attributes:
...
| -------------- | ---------------------------------------------------------------------|
| Regulator      | Create, Read (All assets), Transfer                                |
| Manufacturer   | Read (Own assets), Update (VIN, Make, Model, Colour, Reg), Transfer|
| Dealership     | Read (Own assets), Update (Colour, Reg), Transfer                  |
| Lease Company  | Read (Own assets), Update (Colour, Reg), Transfer                  |
| Leasee         | Read (Own assets), Update (Colour, Reg), Transfer                  |
| Scrap Merchant | Read (Own assets), Scrap                                           |
