...
config.participants.users.buyers[0].type = 'Buyers';
...
config.participants.users.buyers[1].type = 'Buyers';
...
config.participants.users.buyers[2].type = 'Buyers';
...
config.participants.users.traders[0].type = 'Traders';
...
config.participants.users.traders[1].type = 'Traders';
...
config.participants.users.traders[2].type = 'Traders';
...
config.participants.users.cutters[2].type = 'Scrap Merchant';
...
config.participants.users.jewellery_makers[0].type = 'Jewellery_makers';
...
config.participants.users.jewellery_makers[1].type = 'Jewellery_makers';
...
config.participants.users.jewellery_makers[2].type = 'Jewellery_makers;
...
config.participants.users.customers[0].type = 'Customers';
...
config.participants.users.customers[1].type = 'Customers';
...
config.participants.users.customers[2].type = 'Customers';
...
// Buyer
config.participants.buyer = config.participants.users.buyer[0];

// Trader
config.participants.trader = config.participants.users.traders[0];

// Cutter
config.participants.cutter = config.participants.users.cutter[0];

// Jewellery_maker
config.participants.jewellery_maker = config.participants.users.jewellery_maker[0];

// Customer
config.participants.customer = config.participants.users.customer[0];
